                  ...
                  <div className="text-center">
                    {card1.inCart ? (
                      <button
                        ...
                        onClick={() => removeFromCart(card1.id)}
                      >
                        Remove from Cart
                      </button>
                    ) : (
                ...
                <div className="card-footer p-4 pt-0 border-top-0 bg-transparent">
                  <div className="text-center">
                    {card2.inCart ? (
                      <button
                        className="btn btn-outline-dark mt-auto"
                        onClick={() => removeFromCart(card2.id)}
                      >
                        Remove from Cart
                      </button>
                    ) : (
                ...
                <div className="card-footer p-4 pt-0 border-top-0 bg-transparent">
                  <div className="text-center">
                    {card3.inCart ? (
                      <button
                        className="btn btn-outline-dark mt-auto"
                        onClick={() => removeFromCart(card3.id)}
                      >
                        Remove from Cart
                      </button>
                    ) : (
                ...
                <div className="card-footer p-4 pt-0 border-top-0 bg-transparent">
                  <div className="text-center">
                    {card4.inCart ? (
                      <button
                        className="btn btn-outline-dark mt-auto"
                        onClick={() => removeFromCart(card4.id)}
                      >
                        Remove from Cart
                      </button>
                    ) : (
                ...
                <div className="card-footer p-4 pt-0 border-top-0 bg-transparent">
                  <div className="text-center">
                    {card5.inCart ? (
                      <button
                        className="btn btn-outline-dark mt-auto"
                        onClick={() => removeFromCart(card5.id)}
                      >
                        Remove from Cart
                      </button>
                    ) : (
                ...
                <div className="card-footer p-4 pt-0 border-top-0 bg-transparent">
                  <div className="text-center">
                    {card6.inCart ? (
                      <button
                        className="btn btn-outline-dark mt-auto"
                        onClick={() => removeFromCart(card6.id)}
                      >
                        Remove from Cart
                      </button>
                    ) : (
